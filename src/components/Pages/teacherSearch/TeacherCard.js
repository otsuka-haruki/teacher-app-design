import { Card, CardContent, Typography, Button, Avatar, CardMedia, Chip, Stack, Box, Grid } from "@mui/material";
...
const TeacherCard = (props) => {
    ...
    return (
        <Card variant="outlined" sx={{ border: 'none' }}>
            <CardMedia component="img" height={16 * 10} image={bannerImageUrl} sx={{ filter: 'brightness(90%)' }} />
            <CardContent sx={{ position: 'relative' }}>
                ...
                <Grid container spacing={2} sx={{ mt: '0.5rem', textAlign: 'center' }}>
                    <Grid item xs={6}>
